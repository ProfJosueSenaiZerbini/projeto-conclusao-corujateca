...
Section "Main"
	...
	GTKDirectory:
		...
		ReadEnvStr $0 "PATH"
		System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("PATH", "$0;$GTKDIRECTORY").r0'
	...
	SetDiaLanguageVariable:
		System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("LANG", "$APPLANGUAGE").r0'

	SetEnvironmentVariables:
		;=== Stick Dia's directory into the path, just to make sure it gets its plugins
		ReadEnvStr $0 "PATH"
		System::Call 'Kernel32::SetEnvironmentVariableA(t, t) i("PATH", "$0;$PROGRAMDIRECTORY\bin").r0'
