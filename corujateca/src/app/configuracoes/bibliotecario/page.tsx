                  ...
                  <Nav />
                      ...
                      ">
                        ...
                        <Image
                            ...
                            height={170}
                        />
                        <p className="text-3xl mb-3">BIBI DOS ANJOS</p>{/* trocar pelo nome do usuário*/}
                        <p className="text-2xl mb-8">Código de identificação: 123456457855</p>{/* trocar pelo código de identificação do usuário (id) */}

                        <button className="cursor-pointer w-64 bg-button-primary text-text-inverse font-medium py-3 mb-4 rounded-2xl hover:brightness-110 transition shadow-sm">
                        Atualizar Conta
                        </button>
